      ...
      <div className={styles.container}>
        ...
        <main className={styles.main}>
          ...
          <div className={checkboxStyles.checkboxGroup}>
            <input type="checkbox" id="custom-checkbox" className={checkboxStyles.customCheckbox} />
            <span className={checkboxStyles.customCheckboxSpan}></span>
            <label htmlFor="custom-checkbox" className={checkboxStyles.customCheckboxLabel}>
              Check box label
            </label>
          </div>

          <div>
            <label htmlFor="exampleFormControlInput1" className={inputStyles.formInputLabel}>
              Email address
            </label>
            <input
          ...
          <div>
            <label htmlFor="exampleFormControlInput2" className={inputStyles.formInputLabel}>
              Email address
            </label>
            <input
          ...
          <div className={dropdownStyles.container}>
            <button className={dropdownStyles.toggle} type="button" aria-expanded="false">
              Todo
            </button>
          </div>

          <div className={dropdownStyles.container}>
            <button className={`${dropdownStyles.toggle} ${dropdownStyles.active}`} type="button" aria-expanded="false">
              Todo
            </button>
